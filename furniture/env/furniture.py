...
from furniture.env.base import EnvMeta
from furniture.env.unity_interface import UnityInterface
from furniture.env.models import furniture_xmls, furniture_name2id, background_names
from furniture.env.models.objects import MujocoXMLObject
from furniture.env.action_spec import ActionSpec
from furniture.env.mjcf_utils import xml_path_completion
from . import transform_utils as T
from . import image_utils as I
...
class FurnitureEnv(metaclass=EnvMeta):
    ...
    def _load_model_robot(self):
        ...
        """
        if self._agent_type == 'Sawyer':
            from furniture.env.models.robots import Sawyer
            from furniture.env.models.grippers import gripper_factory
            ...
            from furniture.env.models.robots import Baxter
            from furniture.env.models.grippers import gripper_factory
            ...
            from furniture.env.models.robots import Cursor
    ...
    def _load_model_arena(self):
        ...
        from furniture.env.models.arenas import FloorArena
